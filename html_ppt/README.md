...
The top chapter bar shows the current section and can be clicked to jump between the decision frame, data, preparation, EDA, evidence, conclusions, and appendix.

The main presentation contains 17 slides designed for an approximately 9-minute-30-second video. Four appendix slides follow the conclusion and are available for questions.
